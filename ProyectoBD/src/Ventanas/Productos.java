...
public class Productos extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        SALIR.setBackground(new java.awt.Color(51, 0, 204));
        ...
        menu.setBackground(new java.awt.Color(51, 0, 204));
        ...
        nuevo.setBackground(new java.awt.Color(51, 0, 204));
        ...
        grabar.setBackground(new java.awt.Color(51, 0, 204));
        ...
        modificar.setBackground(new java.awt.Color(51, 0, 204));
        ...
        consultar.setBackground(new java.awt.Color(51, 0, 204));
        ...
        borrar.setBackground(new java.awt.Color(51, 0, 204));
    ...
    private void TXT3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_TXT3ActionPerformed
        if (TXT3.getText().equals("")) {
            JOptionPane.showMessageDialog(null, "La Existencia del Producto es requerido");
        } else {
            TXT4.requestFocus();
        }
    ...
    private void TXT4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_TXT4ActionPerformed
        if (TXT4.getText().equals("")) {
            JOptionPane.showMessageDialog(null, "La Unidad del Producto es requerida");
        } else {
