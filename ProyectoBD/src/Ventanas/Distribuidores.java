...
public class Distribuidores extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Producto Distribuido");
        ...
        jLabel10.setText("Distribuidores");

        jLabel11.setFont(new java.awt.Font("Dialog", 1, 14)); // NOI18N
        jLabel11.setForeground(new java.awt.Color(255, 255, 255));
        jLabel11.setText("ID Distribuidor");
        ...
        grabar.setBackground(new java.awt.Color(255, 153, 0));
        ...
        consultar.setBackground(new java.awt.Color(255, 153, 0));
    ...
    public void modificar() {
        try {
            sql = "update DISTRI set ";
            sql += "NOM='" + TXT2.getText() + "',";
            sql += "PRODDISTRI='" + TXT3.getText() + "',";
            sql += "FECLLEG='" + TXT4.getText() + "',";
            sql += "ESTATUS='" + TXT5.getText()+"'" ;
            sql += " where ID_DISTRI=" + TXT1.getText();
            System.out.println(sql);
            atmt = con.prepareStatement(sql);
            sw = atmt.executeUpdate();
            if (sw != 0) {
